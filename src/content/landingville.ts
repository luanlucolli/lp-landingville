export const copy = {
  ...
  demos: {
    id: "demos",
    title: "Landing Page ou Site: qual é a diferença?",
    note: "Em resumo: a Landing Page vende uma coisa. O Site mostra tudo sobre seu negócio.",
    intro: "Gostou do que viu? Vamos criar algo assim para você.",
    tabs: [
      {
        key: "landing",
        title: "Landing Page",
        oneLiner: "Uma página feita pra vender ou captar contatos.",
        images: ["/lovable-uploads/landingcabelo.webp", "/lovable-uploads/landinglanche.webp"],
        highlightIcon: "megaphone",
        highlightTitle: "Quando usar?",
        highlightDescription: "Quando você quer divulgar algo específico — uma promoção, um serviço, um cardápio — e precisa que o cliente entre em contato rápido.",
        benefits: [
          "Página única, direto ao ponto",
          "Botão de WhatsApp sempre visível",
          "Perfeita para campanhas e ofertas",
        ],
      },
      {
        key: "site",
        title: "Site",
        oneLiner: "A vitrine completa do seu negócio na internet.",
        images: ["/lovable-uploads/sitecarbo.webp", "/lovable-uploads/sitecafe.webp"],
        highlightIcon: "network",
        highlightTitle: "Quando usar?",
        highlightDescription: "Quando o cliente quer conhecer seu negócio antes de decidir — saber o que você faz, onde fica, como funciona.",
        benefits: [
          "Várias seções: Início, Sobre, Serviços, Contato",
          "Aparece melhor nas buscas do Google",
          "Passa mais credibilidade e profissionalismo",
        ],
      },
    ],
